  ...
  return (
    <aside className="sideBar">
      ...
      <div className="sideBar_tools upgrade_plan mt-3 px-4">
        <span className="text-black bg-white rounded-2 py-2 px-3 free_btn mb-2">0 <i className="bi bi-star-fill"></i>
          &nbsp; &nbsp; Free</span>
        <h3 className="text-white text-center mb-2">Get more out of PICTRO!</h3>
        <p className="mb-4 text-center">Craft magical AI artworks without
          limits and share them.</p>
        <a href="" className="btn btn-primary upgrade_btn d-flex align-items-center gap-2 justify-content-center">
      ...
      <div className="sideBar_tools user_pictro mt-3 px-4">
        <div className="dropdown">
          <a className="btn w-100 dropdown-toggle d-flex align-items-center gap-2 text-white" href="#" role="button"
